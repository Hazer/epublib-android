...
public interface XMLStreamConstants {
   ...
   * @see extra.javax.xml.stream.events.EntityReference
   */
  public static final int ENTITY_REFERENCE=9;

  /**
   * Indicates an event is an attribute
   * @see extra.javax.xml.stream.events.Attribute
   */
   ...
   * 
   * @see extra.javax.xml.stream.events.Namespace
   */
  public static final int NAMESPACE=13;

  /**
   * Indicates a Notation 
   * @see extra.javax.xml.stream.events.NotationDeclaration
   */
